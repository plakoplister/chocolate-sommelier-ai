...
const { IntelligentSommelier } = require('./intelligent-sommelier.cjs')

class HybridOpenAISommelier extends IntelligentSommelier {
  constructor() {
    super()
...
module.exports = { HybridOpenAISommelier }